...
-- CreateEnum
CREATE TYPE "TeamRole" AS ENUM ('LEADER', 'DEVELOPER', 'DESIGNER', 'RESEARCHER', 'TESTER');

-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'REVIEW', 'DONE');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_UPDATE', 'TEAM_INVITE', 'REVIEW_RECEIVED', 'PROJECT_STATUS', 'GENERAL');
